 ...
 */
public class KeyGeneratorConverterTest extends AbstractStringConverterBasicTest<KeyGenerator> {

    public KeyGeneratorConverterTest() {
        super(new KeyGeneratorConverter(null));
    }

    @Test
    @Ignore
    public void testKeyGenerator() throws NoSuchAlgorithmException, NoSuchPaddingException {
        final String transformation = "AES";
        final KeyGenerator expected = KeyGenerator.getInstance(transformation);
        final KeyGenerator actual = convert(transformation);
    ...
    @Test
    @Ignore
    public void testKeyGeneratorWithProvider() throws NoSuchAlgorithmException, NoSuchPaddingException {
        final String transformation = "AES";
        final KeyGenerator expected = KeyGenerator.getInstance(transformation);
