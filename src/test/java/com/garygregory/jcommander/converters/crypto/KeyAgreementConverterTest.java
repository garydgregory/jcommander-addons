 ...
 */
public class KeyAgreementConverterTest extends AbstractStringConverterBasicTest<KeyAgreement> {

    public KeyAgreementConverterTest() {
        super(new KeyAgreementConverter(null));
    }

    @Test
    @Ignore
    public void testKeyAgreement() throws NoSuchAlgorithmException, NoSuchPaddingException {
        final String transformation = "DiffieHellman";
        final KeyAgreement expected = KeyAgreement.getInstance(transformation);
        final KeyAgreement actual = convert(transformation);
