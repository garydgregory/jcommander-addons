 ...
 * <code class="language-java">&#64;Parameter(names = { "--paramname" }, converter = YearMonthConverter.class)
 * private YearMonth paramname;</code>
 * </pre>
 * <p>
 * 
 * @see YearMonth
...
public class YearMonthConverter extends AbstractBaseConverter<YearMonth> {
     ...
     */
    public YearMonthConverter(final String optionName) {
        super(optionName, YearMonth.class);
    }
