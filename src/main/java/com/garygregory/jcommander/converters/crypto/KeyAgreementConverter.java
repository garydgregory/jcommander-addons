 ...
 * <code class="language-java">&#64;Parameter(names = { "--keyAgreement" }, converter = KeyAgreementConverter.class)
...
public class KeyAgreementConverter extends AbstractBaseConverter<KeyAgreement> {
    ...
    protected KeyAgreement convertImpl(final String value)
        ...
        return isSingle(split) ? KeyAgreement.getInstance(value) : KeyAgreement.getInstance(algorithm, split[1]);
    }
