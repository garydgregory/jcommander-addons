 ...
 * </p>
 * <p>
 * To get a KeyGenerator from a specific {@link Provider}, use the syntax {@code algorithm:provider} as described by
 * {@link KeyGenerator#getInstance(String, String)}.
 * </p>
 * 
 * <p>
 * Example:
 ...
 * private KeyGenerator paramname;</code>
 * </pre>
 * <p>
 * 
 * @see KeyGenerator
...
public class KeyGeneratorConverter extends AbstractBaseConverter<KeyGenerator> {
    ...
    protected KeyGenerator convertImpl(final String value)
        ...
        return isSingle(split) ? KeyGenerator.getInstance(value) : KeyGenerator.getInstance(algorithm, split[1]);
    }
