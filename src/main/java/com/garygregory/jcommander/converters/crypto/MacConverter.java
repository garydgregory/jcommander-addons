 ...
 * </p>
 * <p>
 * To get a Mac from a specific {@link Provider}, use the syntax {@code transformation:provider} as
...
public class MacConverter extends AbstractBaseConverter<Mac> {
    ...
    protected Mac convertImpl(final String value)
        ...
        return isSingle(split) ? Mac.getInstance(value) : Mac.getInstance(transformation, split[1]);
    }
