...
/**
 * Converts a {@link String} into a SQL {@link Timestamp}.
 * <p>
 * For a description of the format, see {@link Timestamp#valueOf(String)}.
 * </p>
 * 
 * <p>
 * Example:
 ...
 * <code class="language-java">&#64;Parameter(names = { "--timestamp" }, converter = TimestampConverter.class)
...
public class TimestampConverter extends AbstractBaseConverter<Timestamp> {
    ...
    @Override
    protected Timestamp convertImpl(final String value) {
