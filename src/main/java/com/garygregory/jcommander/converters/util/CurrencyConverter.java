...
/**
 * Converts a {@link String} into a {@link Currency}.
 * <p>
 ...
 * <code class="language-java">&#64;Parameter(names = { "--currency" }, converter = CurrencyConverter.class)
 * private Currency currency;</code>
 * </pre>
 * <p>
 * 
 * @see Currency
...
public class CurrencyConverter extends AbstractBaseConverter<Currency> {
    ...
    @Override
    protected Currency convertImpl(final String value) {
