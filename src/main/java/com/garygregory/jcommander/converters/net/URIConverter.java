 ...
 */
public class URIConverter extends AbstractBaseConverter<URI> {
    ...
    @Override
    protected URI convertImpl(final String value) throws URISyntaxException {
