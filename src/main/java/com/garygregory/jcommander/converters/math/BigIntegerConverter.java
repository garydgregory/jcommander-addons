 ...
 * <code class="language-java">&#64;Parameter(names = { "--bigInteger" }, converter = BigIntegerConverter.class)
 * private BigInteger bigInteger;</code>
 * </pre>
 * <p>
 * 
 * @see BigInteger
...
public class BigIntegerConverter extends AbstractBaseConverter<BigInteger> {
    ...
    @Override
    protected BigInteger convertImpl(final String value) {
